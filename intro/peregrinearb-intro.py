from peregrinearb import get_exchanges_for_market
from peregrinearb.async_find_opportunities import get_opportunity_for_market
import asyncio
...
async def trade(exchanges: list, market_name, amount):
    ...
    """
    opportunity = await get_opportunity_for_market('btc_usd', exchanges='binance', name=False)
